...
[ -e /usr/share/opsi-client-agent/opsiclientd/static_html ] || ln -s /workspace/opsiclientd_data/common/static_html /usr/share/opsi-client-agent/opsiclientd/static_html
